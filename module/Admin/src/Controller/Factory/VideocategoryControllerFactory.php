<?php
/* * * * * * * * * * * * * * * * * * * * * * * * *
* Admin panel: Video Category Controller Factory
* * * * * * * * * * * * * * * * * * * * * * * * */
...
use Admin\Controller\VideocategoryController;
use Zend\Session\Container;

class VideocategoryControllerFactory implements FactoryInterface
{
    ...
    {	
		...
		return new VideocategoryController($AbstractModel,$Adapter,$adminMsgsession,$EmailModel,$config_data);
    }
}