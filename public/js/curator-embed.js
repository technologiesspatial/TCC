    ...
    function (t, e, n) {
        ...
        for (
            var oo = eo,
                ...
                lo = {},
                po = "\nid,en,da,de,it,nl,es,fr,po,ru,sl,fi,pl,ar,zh,jp,pt-br,kr,th\nload-more,Load more,Hent mere,Mehr anzeigen,Di più,Laad meer,Cargar más,Voir plus,Carregar Mais,????????? ??????,Prikaži ve?,Lataa lisää,,????? ??????,????,?????,Carregar mais,? ??,?????????\nminutes-ago.1,{n} minute ago,{n} minut siden,Vor einer Minute,Un minuto fa,{n} minuut geleden,Hace un minuto,Il y a {n} minute,Tem um minuto,???? ?????? ?????,pred {n} minuto,{n} minuutti sitten,,??? {n} ?? ???????,{n}???,{n} ??,há {n} minuto,{n} ? ??,???????????\nminutes-ago.n,{n} minutes ago,{n} minutter siden,Vor {n} Minuten,{n} minuti fa,{n} minuten geleden,Hace {n} minutos,Il y a {n} minutes,Tem {n} minutos,{n} ????? ?????,pred {n} minutami,{n} minuuttia sitten,,??? {n} ?? ???????,{n}???,{n} ??,há {n} minutos,{n} ? ??,???????????????\nhours-ago.1,{n} hour ago,{n} time siden,Vor einer Stunde,Un'ora fa,{n} uur geleden,Hace una hora,Il y a {n} heure,Tem {n} hora,???? ??? ?????,pred {n} uro,{n} tunti sitten,,??? {n} ?? ???????,{n}???,{n} ???,há {n} hora,{n} ?? ??,??????????????\nhours-ago.n,{n} hours ago,{n} timer siden,Vor {n} Stunden,{n} ore fa,{n} uren geleden,Hace {n} horas,Il y a {n} heures,Tem {n} horas,{n} ????? ?????,pred {n} urami,{n} tuntia sitten,,??? {n} ?? ???????,{n}???,{n} ???,há {n} horas,{n} ?? ??,??????????????????\ndays-ago.1,{n} day ago,{n} dag siden,Vor einem Tag,Un giorno fa,{n} dag geleden,Hace un día,Il y a {n} jour,Faz um dia,???? ???? ?????,pred {n} dnevom,{n} päivä sitten,,???{n} ?? ??????,{n}??,{n} ??,há {n} dia,{n} ? ??,???????\ndays-ago.n,{n} days ago,{n} dage siden,Vor {n} Tagen,{n} giorni fa,{n} dagen geleden,Hace {n} días,Il y a {n} jours,Fazem {n} dias,{n} ???? ?????,pred {n} dnevi,{n} päivää sitten,,???{n} ?? ??????,{n}??,{n} ??,há {n} dias,{n} ? ??,???????????\nweeks-ago.1,{n} week ago,{n} uge siden,Vor einer Woche,Una settimana fa,{n} week geleden,Hace una semana,Il y a {n} semaine,Faz uma semana,???? ?????? ?????,pred {n} tednom,{n} viikko sitten,,??? {n} ?? ????????,{n}??,{n} ???,há {n} semana,{n} ? ??,???????????\nweeks-ago.n,{n} weeks ago,{n} uger siden,Vor {n} Wochen,{n} settimane fa,{n} weken geleden,Hace {n} semanas,Il y a {n} semaines,Fazem {n} semanas,{n} ?????? ?????,pred {n} tedni,{n} viikkoa sitten,,??? {n} ?? ????????,{n}??,{n} ???,há {n} semanas,{n} ? ??,???????????????\nmonths-ago.1,{n} month ago,{n} måned siden,Vor einem Monat,Un mese fa,{n} maand geleden,Hace un mes,Il y a {n} mois,Tem um mês,???? ????? ?????,pred {n} mesecem,{n} kuukausi sitten,,??? {n} ?? ??????,{n}???,{n} ???,há {n} mês,{n} ? ??,?????????\nmonths-ago.n,{n} months ago,{n} måneder siden,Vor {n} Monaten,{n} mesi,{n} maanden geleden,Hace {n} meses,Il y a {n} mois,Tem {n} meses,{n} ??????? ?????,pred {n} meseci,{n} kuukautta sitten,,??? {n} ?? ??????,{n}???,{n} ???,há {n} meses,{n} ? ??,?????????????\nyesterday,Yesterday,I går,Gestern,Ieri,Gisteren,Ayer,Hier,Ontem,?????,V?eraj,Eilen,,???????,??,??,Ontem,??,????????\njust-now,Just now,Lige nu,Eben,Appena,Nu,Ahora,Il y a un instant,Agora,?????? ???,Pravkar,Juuri nyt,,????,??,????,Agora,??,????????????\nprevious,Previous,Forrige,Zurück,Indietro,Vorige,Anterior,Précédent,Anterior,??????????,Prejšnji,Edellinen,,??????,???,????,Anterior,??,????????\nnext,Next,Næste,Weiter,Più,Volgende,Siguiente,Suivant,Próximo,?????????,Naslednji,Seuraava,,??????,???,????,Próximo,??,?????\ncomments,Comments,Kommentarer,Kommentare,Commenti,Comments,Comentarios,Commentaires,Comentários,???????????,Komentarji,Kommenttia,,???????,??,????,Comentários,??,???????????\nlikes,Likes,Synes godt om,Gefällt mir,Mi piace,Likes,Me gusta,J'aime,Curtir,?????,Vše?ki,Tykkäystä,,???????,?,???,Curtidas,???,?????\nread-more,Read more,Læs mere,Weiterlesen,Di più,Lees meer,Leer más,En savoir plus,Leia mais,?????????,Preberi ve?,Lue lisää,,????? ??????,????,?????,Leia mais,? ????,?????????????\nfilter,Filter,Filter,Filtern,filtrare,Filtreren,filtrar,filtrer,Filtro,???????????,Filter,Suodata,,?????,??,?????,Filtro,??,???????\nall,All,Alle,Alle,Tutti,Alle,Todas,Tout,Todos,???,Vsi,Kaikki,,??????,??,??,Tudo,??,???????\ngo-to-original-post,Go to original post,Gå til originalt oplsag,Original-Post ansehen,,Ga naar het bericht,Ver publicación original,Voir la publication,,,,Näytä alkuperäinen viesti,,?????? ??????? ??????,????,?????,Ir para o conteúdo original,??? ???? ??,?????????????????\nfilter-source,Filter source,Filter kilde,Filtern,Filtrare,Filtreren,Filtrar,Filtrer,Filtro,???????????,Filter,Suodata lähde,,????? ???? ??????,???,????????,Filtro por fonte,?? ??,?????????????????\nfilter-network,Filter network,Filter netværk,Filtern,Filtrare,Filtreren,Filtrar,Filtrer,Filtro,???????????,Filter,Suodata palvelu,,????? ???? ??????,????,???????????,Filtro por rede social,?? ????,????????????????\nno-posts,The feed contains no posts,Der er ingen opslag i dette feed,Der Feed enthält keine Posts,,,,,,,,Syötteessä ei ole sisältöä,,??? ?? ???????? ?? ???????,???????????,????????????????,Este feed está vazio,??? ???? ????,??????????\nalt-image-posted,Image posted by {userName} to {networkName},Billede slået op af {userName} på {networkName},,,,,,,,,{networkName} kuva lisätty käyttäjän {userName} toimesta,,????? ?????? ?? ??? ???????? {userName} ??? ?????? {networkName},???{userName}???{networkName},,Imagem publicada por {userName} no {networkName},{userName} ?  {networkName} ? ???? ???,?????????????? (??????????) ????? (?????????????)\nalt-profile-image,Profile image for {userName},Profilbillede for {userName},,,,,,,,,Käyttäjän {userName} profiilikuva,,???? ??? ???????? {userName},{userName}?????,,Imagem de perfil para {userName},{userName} ? ??? ???,????????????????? (??????????)".split(
                    "\n"
                ),
                ho = po.length - 1;
            ho >= 0;
